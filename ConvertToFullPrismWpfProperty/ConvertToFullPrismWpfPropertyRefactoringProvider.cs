...
namespace ConvertToFullPrismWpfProperty
{
    ...
    public class ConvertToFullPrismWpfPropertyRefactoringProvider : CodeRefactoringProvider
    {
        ...
        public sealed override async Task ComputeRefactoringsAsync(CodeRefactoringContext context)
        {
            ...
            {
                var action = CodeAction.Create("Convert to full Prism WPF property", cancellationToken => ConvertToFullPrismWpfProperty(context.Document, selectedAutoPropertyDeclarationSyntaxes, cancellationToken));
